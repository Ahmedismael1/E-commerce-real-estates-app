...
class _FavouriteScreenState extends State<FavouriteScreen> {
  ...
  Widget getAllFavourite(Data data, context, index) => Card(
        elevation: 5,
        child: Container(
          child: Row(
            children: [
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        HomePageCubit.get(context).propertyDetailsNum =
                            HomePageCubit.get(context)
                                .homeModel
                                .data
                                .properties[index]
                        ...
                        print(HomePageCubit.get(context).propertyDetailsNum);
